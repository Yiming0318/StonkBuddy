    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, default='profiles/default_avatar.jpg', null=True, upload_to='profiles/')),
                ('social_twitter', models.CharField(blank=True, max_length=200, null=True)),
                ('social_reddit', models.CharField(blank=True, max_length=200, null=True)),
